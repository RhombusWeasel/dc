    ...
    system: {
        templates: {
            character: function(changes) {
                let char = {};
                utils.system.tools.templates.iterate(char, utils.game_data.templates.entity);
                utils.system.tools.templates.iterate(char, utils.game_data.templates.stats);
                utils.system.tools.templates.iterate(char, utils.game_data.templates.pools);
                utils.system.tools.templates.iterate(char, utils.game_data.templates.skills);
                return char;
            },

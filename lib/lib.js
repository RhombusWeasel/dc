utils = {
        ...
        */
        ...
        templates: {
            operations: {
                    ...
                    if (!(val)) {
                        console.log('DC : utils.tools.operations.ensure : setting', data, changes);
    ...
    system: {
        new: {
            stats: function() {
                return utils.tools.templates.iterate({}, utils.templates.stats);
            },
            entity: function(changes) {
                ...
                char = utils.tools.templates.iterate(char, utils.templates.spells);
                return char;
            },

    ...
    system: {
        ...
        templates: {
            ...
            character: function(changes) {
                let char = {};
                utils.templates.iterate(char, utils.template.templates.entity);
                utils.templates.iterate(char, utils.template.templates.stats);
                utils.templates.iterate(char, utils.template.templates.pools);
                utils.templates.iterate(char, utils.template.templates.skills);
                return char;
            },

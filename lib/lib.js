    ...
    system: {
        ...
        templates: {
            ...
            character: function(changes) {
                let char = {};
                utils.system.templates.iterate(char, utils.template.templates.entity);
                utils.system.templates.iterate(char, utils.template.templates.stats);
                utils.system.templates.iterate(char, utils.template.templates.pools);
                utils.system.templates.iterate(char, utils.template.templates.skills);
                return char;
            },

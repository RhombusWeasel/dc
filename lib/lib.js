        ...
        */
        ...
        templates: {
            operations: {
                    ...
                    console.log('DC : utils.tools.templates.operations.ensure : ', data);
                    return data;
                },
            ...
            iterate: function(data, changes) {
                for (let i = 0; i < changes.length; i++) {
                    if (utils.tools.templates.operations?.[changes.mode]) utils.tools.templates.operations[mode](data, changes);
                }
                return data;
            },
            modify: function(data, changes) {

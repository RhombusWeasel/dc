utils = {
    gm: {
        ...
        save_system: function() {
            utils.journal.save(game.settings.get('dc', 'system_journal'), utils.template);
    ...
    system: {
        ...
        templates: {
            ...
            character: function(changes) {
                let char = {};
                utils.system.templates.iterate(char, utils.system.template.templates.entity);
                utils.system.templates.iterate(char, utils.system.template.templates.stats);
                utils.system.templates.iterate(char, utils.system.template.templates.pools);
                utils.system.templates.iterate(char, utils.system.template.templates.skills);
                return char;
            },

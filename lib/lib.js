    ...
    system: {
        ...
        templates: {
            ...
            character: function(changes) {
                let char = {};
                utils.system.templates.iterate(char, utils.template.entity);
                utils.system.templates.iterate(char, utils.template.stats);
                utils.system.templates.iterate(char, utils.template.pools);
                utils.system.templates.iterate(char, utils.template.skills);
                return char;
            },

        ...
        */
        ...
        templates: {
            ...
            iterate: function(data, changes) {
                //console.log('DC : utils.templates.iterate : ', data, changes);
            ...
            modifiers: {
                operations: {
                    ...
                    pool: function(data) {
                        return {mode: 'ensure', path: data.path, value: data.value, label: data.label, descriptions: data.descriptions, image: data.image};
                    },

    ...
    system: {
        templates: {
            character: function(changes) {
                let char = {};
                utils.tools.templates.iterate(char, utils.game_data.templates.entity);
                utils.tools.templates.iterate(char, utils.game_data.templates.stats);
                utils.tools.templates.iterate(char, utils.game_data.templates.pools);
                utils.tools.templates.iterate(char, utils.game_data.templates.skills);
                return char;
            },
